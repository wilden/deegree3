...
public class WCSController extends AbstractOGCServiceController {
    ...
    private final static String CONFIG_SCHEMA_FILE = "/META-INF/schemas/wcs/0.4.0/wcs_service_configuration.xsd";

    private final static String PUBLISHED_SCHEMA_FILE = "/META-INF/schemas/wcs/0.4.0/wcs_published_information.xsd";
