...
public class WPVSController extends AbstractOGCServiceController {
    ...
    private final static String CONFIG_SCHEMA_FILE = "/META-INF/schemas/wpvs/0.4.0/wpvs_service_configuration.xsd";

    private final static String PUBLISHED_SCHEMA_FILE = "/META-INF/schemas/wpvs/0.4.0/wpvs_published_information.xsd";
