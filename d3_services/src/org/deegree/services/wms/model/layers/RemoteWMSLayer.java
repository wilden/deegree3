...
import static org.deegree.commons.utils.MapUtils.calcScaleWMS111;
...
public class RemoteWMSLayer extends Layer {
    ...
    public Pair<BufferedImage, LinkedList<String>> paintMap( GetMap gm, Style style ) {
        ...
        try {
            ...
            double scale = calcScaleWMS111( width, height, gm.getBoundingBox(), null );
            double newScale = calcScaleWMS111( width, height, bbox, null );
