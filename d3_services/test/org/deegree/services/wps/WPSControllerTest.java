...
public class WPSControllerTest {
    ...
    private static Logger LOG = LoggerFactory.getLogger( WPSControllerTest.class );
    ...
    public void testControllerConstructor() {
        ...
        try {
            ...
            c.init( new XMLAdapter (new File ("test/org/deegree/controller/wps/wps_configuration.xml")), null );
    ...
    public void testIncorrectConfigurationFile()
                            throws Exception {
        WPSController c = new WPSController();
        c.init( new XMLAdapter (new File ("test/org/deegree/controller/wps/wps_incorrect_configuration.xml")), null );
        c.doKVP( new HashMap<String, String>(), null, null, null );
