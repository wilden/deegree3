...
import org.deegree.test.services.hash.HashValidator;
...
public class TestingToolBox {
    ...
    private final TestInfo[] tests = {
                                      new TestInfo( WPVSStressTest.class,
                                                    "Sends getView requests to the deegree3 WPVS. Multiple thread testing is supported." ),
                                      new TestInfo( HashValidator.class,
                                                    "Validates requests against a service using expected md5 hashes." ) };
