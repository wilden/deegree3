...
public class RasterTreeGridifier {
    ...
    public static void main( String[] args )
        ...
        try {
            ...
            String rtbBaseDir = line.getOptionValue( RasterOptionsParser.OPT_RASTER_DIR );
            ...
            RasterIOOptions ioOptions = RasterOptionsParser.parseRasterIOOptions( line, DataType.BYTE );
