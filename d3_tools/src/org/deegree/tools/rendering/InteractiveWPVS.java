...
public class InteractiveWPVS extends GLCanvas implements GLEventListener, KeyListener {
     ...
     */
    public InteractiveWPVS( XMLAdapter configAdapter, ServiceConfiguration sc, ViewParams params, float zScale )
        ...
        flightControls = new FlightControls( this, this.params );
