...
public class DEMRasterFilterer {
    ...
    private static void startFilterer( CommandLine line )
        ...
        RasterIOOptions options = RasterOptionsParser.parseRasterIOOptions( line, DataType.FLOAT );
        ...
        AbstractRaster raster = RasterOptionsParser.loadRaster( line, options );

        DEMRasterFilterer filter = new DEMRasterFilterer( raster, kernelSize, stdCorr, cacheDir, outputDirectory,
                                                          outputType );
        filter.applyFilter();
    }
