//$HeadURL: svn+ssh://svn.wald.intevation.org/deegree/deegree3/trunk/deegree-core/deegree-core-commons/src/main/java/org/deegree/commons/config/ResourceState.java $
/*----------------------------------------------------------------------------
 ...
 * 
 * @version $Revision: 32262 $, $Date: 2011-10-23 12:15:56 +0200 (Sun, 23 Oct 2011) $
 */
public class ResourceState<T extends Resource> {
     ...
     *            exception)
     */
    public ResourceState( String id, File configLocation, ResourceProvider<T> provider, StateType type, T resource,
