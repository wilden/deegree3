 ...
 * 
 */
public class ResponseDocumentFormat implements ResponseFormat {
    ...
    public ResponseDocumentFormat( DocumentOutputDefinition[] outputDefs, Boolean storeExecuteResponse,
                                   Boolean lineage, Boolean status ) {
    ...
    public DocumentOutputDefinition[] getDocOutputDefs() {
        return outputDefs;
    }
